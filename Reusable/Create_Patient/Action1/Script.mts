...
JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Address").Set DataTable.Value("PT_ADDRESS","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("City").Set DataTable.Value("PT_CITY","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaList("State").Select DataTable.Value("PT_STATE","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("ZIP Code").Set DataTable.Value("PT_ZIPCODE","Global")
...
JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Home Phone Number").Set DataTable.Value("PT_PHONE","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Date of Birth").Set DataTable.Value("PT_DOB","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaList("Gender").Select DataTable.Value("PT_GENDER","Global")
