...
JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaEdit("Last Name").Set DataTable.Value("PT_LASTNAME3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaEdit("First Name").Set DataTable.Value("PT_FIRSTNAME3","Global")
...
JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Address").Set DataTable.Value("PT_ADDRESS3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("City").Set DataTable.Value("PT_CITY3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaList("State").Select DataTable.Value("PT_STATE3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("ZIP Code").Set DataTable.Value("PT_ZIPCODE3","Global")
...
JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Home Phone Number").Set DataTable.Value("PT_PHONE3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaEdit("Date of Birth").Set DataTable.Value("PT_DOB3","Global")

JavaWindow("Enterprise Pharmacy System").JavaDialog("Patient Search").JavaDialog("Add Patient").JavaList("Gender").Select DataTable.Value("PT_GENDER3","Global")
